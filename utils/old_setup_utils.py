...
def create_bodies(use_MCD_atmo=False, use_MCD_winds=False, sat=None):
    # Create bodies
    ...
    mass = 200 if sat is None else sat.wet_mass
    bodies.get_body("Satellite").set_constant_mass(mass)
    ...
    if sat is None:
        ...
        def force_coefficients(_):
            ...
            C_d = sat.get_cd(h)
            return [C_d, 0, 0]
        aero_coefficient_settings = environment_setup.aerodynamic_coefficients.custom(force_coefficients, sat.S_ref, [])
