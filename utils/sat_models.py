...
satellites_with_tank = {
    ...
    "CS_3021": satellite("CS_3021", 4.88375, [1.95032, 2.13827, 2.15149], S_ref=0.042258285, S_t=5e-4, SA_areas=[0.031058, 0.263343, 0.083343], prop_mass=0.65, comp_ratio=[1, 2, 3])
}