...
satellites = {
    "CS_0020": satellite("CS_0020", 2.42425, [2.91898, 2.92598, 2.86794], S_ref=0.01, SA_areas=[0, 0.042426, 0.042426]),
    "CS_0021": satellite("CS_0021", 2.93225, [4.54414, 5.21927, 6.93935], S_ref=0.0104, SA_areas=[0.031058, 0.083343, 0.083343]),
    "CS_1020": satellite("CS_1020", 2.93225, [1.01005, 1.02643, 0.85362], S_ref=0.041058285, SA_areas=[0, 0.102426, 0.042426]),
    "CS_1021": satellite("CS_1021", 3.44025, [5.29961, 5.93222, 7.18779], S_ref=0.0108, SA_areas=[0.031058, 0.143343, 0.083343]),
    "CS_2020": satellite("CS_2020", 3.44025, [1.29512, 1.32335, 1.00754], S_ref=0.041458285, SA_areas=[0, 0.162426, 0.042426]),
    "CS_2021": satellite("CS_2021", 3.94825, [6.28985, 6.92407, 7.52191], S_ref=0.0112, SA_areas=[0.031058, 0.203343, 0.083343]),
    "CS_2120": satellite("CS_2120", 3.94825, [1.57640, 1.67884, 1.24272], S_ref=0.041858285, SA_areas=[0, 0.282426, 0.042426]),
    "CS_3020": satellite("CS_3020", 4.45625, [6.02714, 6.19718, 4.49018], S_ref=0.0108, SA_areas=[0, 0.222426, 0.042426]),
    "CS_3021": satellite("CS_3021", 4.45625, [1.95032, 2.13827, 2.15149], S_ref=0.042258285, SA_areas=[0.031058, 0.263343, 0.083343])
}

satellites_with_tank = {
    "CS_0020": satellite("CS_0020", 2.85175, [2.91898, 2.92598, 2.86794], S_ref=0.01, SA_areas=[0, 0.042426, 0.042426], prop_mass=0.65),
    "CS_0021": satellite("CS_0021", 3.35975, [4.54414, 5.21927, 6.93935], S_ref=0.0104, SA_areas=[0.031058, 0.083343, 0.083343], prop_mass=0.65),
    "CS_1020": satellite("CS_1020", 3.35975, [1.01005, 1.02643, 0.85362], S_ref=0.041058285, SA_areas=[0, 0.102426, 0.042426], prop_mass=0.65),
    "CS_1021": satellite("CS_1021", 3.86775, [5.29961, 5.93222, 7.18779], S_ref=0.0108, SA_areas=[0.031058, 0.143343, 0.083343], prop_mass=0.65),
    "CS_2020": satellite("CS_2020", 3.86775, [1.29512, 1.32335, 1.00754], S_ref=0.041458285, SA_areas=[0, 0.162426, 0.042426], prop_mass=0.65),
    "CS_2021": satellite("CS_2021", 4.37575, [6.28985, 6.92407, 7.52191], S_ref=0.0112, SA_areas=[0.031058, 0.203343, 0.083343], prop_mass=0.65),
    "CS_2120": satellite("CS_2120", 4.37575, [1.57640, 1.67884, 1.24272], S_ref=0.041858285, SA_areas=[0, 0.282426, 0.042426], prop_mass=0.65),
    "CS_3020": satellite("CS_3020", 4.88375, [6.02714, 6.19718, 4.49018], S_ref=0.0108, SA_areas=[0, 0.222426, 0.042426], prop_mass=0.65),
    "CS_3021": satellite("CS_3021", 4.88375, [1.95032, 2.13827, 2.15149], S_ref=0.042258285, SA_areas=[0.031058, 0.263343, 0.083343], prop_mass=0.65)
}