...
initial_state = SU.get_initial_state(bodies, altitude=135e3, eccentricity=0)
...
acceleration_settings = {"Satellite":
    dict(
        ...
        Satellite = [  T.thrust_settings(bodies, satellite, simulation_start_epoch, save_power=True) ]
    )}
