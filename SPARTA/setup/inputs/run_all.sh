...
mpirun -np 16 spa_ < in.CS_1021_85km | tee ../results_sparta/CS_1021/stats_85km.dat
...
mpirun -np 16 spa_ < in.CS_2021_85km | tee ../results_sparta/CS_2021/stats_85km.dat
